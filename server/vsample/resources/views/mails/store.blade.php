                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:6px; overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:20px; font-size:15px; color:#333333; line-height: 1.5rem;">
                            ...
                            <p>{{ 'Thank you for using our service. your website has been created successfully, visit your website bellow .' }}</p>
                        </td>
                    </tr>

                    <!-- CTA Button -->
                    <tr>
                        <td align="center" style="width:100%;padding:20px;display:flex;justify-content:center;align-items:center;gap:10px;">
                            <div align="center" style="width:100%;display:flex;justify-content:center;align-items:center;">
                                <a href="{{ $frontUrl ?? '#' }}" style="margin-left:7rem;background:#ffb400; color:#000; padding:14px 30px; font-size:15px; font-weight:bold; text-decoration:none; border-radius:4px; display:inline-block;">
                                    {{ 'Client Website' }}
                                </a> &nbsp; &nbsp; 
                                @if ( !empty($adminUrl) )
                                    <a href="{{ $adminUrl }}" style="background:#ffb400; color:#000; padding:14px 30px; font-size:15px; font-weight:bold; text-decoration:none; border-radius:4px; display:inline-block;">
                                        {{ 'Admin Panel' }}
                                    </a>
                                @endif
                            </div>
