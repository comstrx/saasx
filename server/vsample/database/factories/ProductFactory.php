...
class ProductFactory extends Factory {
    ...
    public function definition () {
        ...
        return [
            ...
            'new_price'     => $this->faker->randomFloat(2, 5, 100),
            'cancel_before' => $this->faker->dateTimeBetween('now', '+7 days'),
            'refund_before' => $this->faker->dateTimeBetween('now', '+10 days'),
            'cancel_cost'   => $this->faker->randomFloat(2, 0, 10),
            'max_quantity'  => $this->faker->numberBetween(1, 20),
        ];
