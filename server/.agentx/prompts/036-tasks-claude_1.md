Your current task is .agentx/tasks/0012-hastenant-dna.md. The full ordered plan lives under .agentx/tasks/ for context, but THIS turn you
drive .agentx/tasks/0012-hastenant-dna.md and only it to done - do not jump ahead to later tasks. First read every prior executor report
