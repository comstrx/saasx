Your current task is .agentx/tasks/0016-rbac-resolver.md. The full ordered plan lives under .agentx/tasks/ for context, but THIS turn you
drive .agentx/tasks/0016-rbac-resolver.md and only it to done - do not jump ahead to later tasks. First read every prior executor report
